...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    if ($response->itemAt('status') == 'success') {
        exit(AvangEmailApi_Json::encode(array(
            'status'    => 'success',
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.avangemail.com/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="https://cdn.avangemail.com/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="https://cdn.avangemail.com/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://cdn.avangemail.com/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="http://www.avangemail.com/favicon.ico" type="image/x-icon" />

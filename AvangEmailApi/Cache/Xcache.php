<?php
/**
 * This file contains the APC cache class used in the AvangEmailApi PHP-SDK.
 * 
...
/**
 * AvangEmailApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class AvangEmailApi_Cache_Xcache extends AvangEmailApi_Cache_Abstract
{
    /**

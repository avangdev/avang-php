<?php
/**
 * This file contains the File cache class used in the AvangEmailApi PHP-SDK.
 * 
...
/**
 * AvangEmailApi_Cache_File makes use of the file system in order to cache data.
 * 
 * @author Serban George Cristian <cristian.serban@mailwizz.com>
 ...
 * @since 1.0
 */
class AvangEmailApi_Cache_File extends AvangEmailApi_Cache_Abstract
{
    /**
     ...
     * @return AvangEmailApi_Cache_File
     */

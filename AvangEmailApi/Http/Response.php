<?php
/**
 * This file contains the AvangEmailApi_Http_Response class used in the AvangEmailApi PHP-SDK.
 * 
...
/**
 * AvangEmailApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author Serban George Cristian <cristian.serban@mailwizz.com>
 ...
 * @since 1.0
 */
class AvangEmailApi_Http_Response extends AvangEmailApi_Base
{
    /**
    ...
    /**
     * @var AvangEmailApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var AvangEmailApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var AvangEmailApi_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var AvangEmailApi_Http_Request
     */
    public $request;
     ...
     * Contructor.
     * 
     * @param AvangEmailApi_Http_Request $request
     */
    public function __construct(AvangEmailApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new AvangEmailApi_Params($params);
        }

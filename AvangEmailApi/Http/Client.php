<?php
/**
 * This file contains the AvangEmailApi_Http_Client class used in the AvangEmailApi PHP-SDK.
 * 
...
/**
 * AvangEmailApi_Http_Client is the http client interface used to make the remote requests and receive the responses.
 * 
 * @author Serban George Cristian <cristian.serban@mailwizz.com>
 ...
 * @since 1.0
 */
class AvangEmailApi_Http_Client extends AvangEmailApi_Base
{
    /**
    ...
    /**
     * @var AvangEmailApi_Params the GET params sent in the request.
     */
    public $paramsGet = array();
    
    /**
     * @var AvangEmailApi_Params the POST params sent in the request.
     */
    public $paramsPost = array();
    
    /**
     * @var AvangEmailApi_Params the PUT params sent in the request.
     */
    public $paramsPut = array();
    
    /**
     * @var AvangEmailApi_Params the DELETE params sent in the request.
     */
    public $paramsDelete = array();
    
    /**
     * @var AvangEmailApi_Params the headers sent in the request.
     */
    ...
    public function __construct(array $options = array())
    {
        ...
        foreach (array('paramsGet', 'paramsPost', 'paramsPut', 'paramsDelete', 'headers') as $param) {
            if (!($this->$param instanceof AvangEmailApi_Params)) {
                $this->$param = new AvangEmailApi_Params($this->$param);
            }
        }
    }
    ...
    {
        $request = new AvangEmailApi_Http_Request($this);

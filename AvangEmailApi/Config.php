<?php
/**
 * This file contains the configuration class for the AvangEmailApi PHP-SDK.
 *
...
/**
 * AvangEmailApi_Config contains the configuration class that is injected at runtime into the main application. 
 * 
 ...
 */
class AvangEmailApi_Config extends AvangEmailApi_Base
{
    /**
    ...
    public function __construct(array $config = array())
    {
        if(!isset($config['apiUrl'])){
            $config = array_merge($config,array('apiUrl'=> 'https://avangemail.net/api'));
        }

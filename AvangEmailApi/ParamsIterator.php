...
/**
 * AvangEmailApi_ParamsIterator implements an interator for {@link AvangEmailApi_Params}.
 *
 * It allows AvangEmailApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class AvangEmailApi_ParamsIterator implements Iterator
{
	/**
